...
const creeperawman = new Discord.RichEmbed()
	.addField("Aw man", "So we back in the mine")
	.addField("got our pick axe swinging side to side", "Side-side to side")
	.addField("This task a grueling one", "hope to find some diamonds tonight")
	.addField("night night", "diamonds tonight")
	.addField("heads up", "You hear a sound")
	.addField("turn around and look up", "total shock fills your body")
	.addField("oh no its you again", "i can never forget those eyes eyes eyes")
	.addField("eyes eyes eyes", "cause baby tonight")
	.addField("the creepers tryna steal all our stuff again", "cause baby tonight")
	.addField("your grab your pick shovel and bolt again", "and run run until its done done")
	.addField("until the sun comes up in the morn", "cause baby tonight")
	.addField("the creepers tryna steal all our stuff again", "just when you think youre safe")
	.addField("overhear some hissing from right behind", "right right behind")
	.addField("thats a nice life you have", "shame its gotta end at this time time time")
	.addField("time ti time time", "blows up")
	.addField("then your health bar drops and you could use a one up", "get inside dont be tardy")
	.addField("so now youre stuck in there", "half a heart is left but dont die die die")
	.addField("die die die", "cause baby tonight")
	.addField("the creepers tryna steal all our stuff again", "cause baby tonight")
	.addField("your grab your pick shovel and bolt again", "and run run until its done done")
	.addField("until the sun comes up in the morn", "cause baby tonight")
	.addField("the creepers tryna steal all our stuff again", "dig up diamonds and craft those diamonds")
	.addField("and make some armour get it baby", "go and forge that like you so mlg pro")
	.addField("the swords made of diamonds so come at me bro", "training in your room under the torchlight")
	.addField("hone that form to get you ready for the big fight", "every single day and the whole night")
const creeperawwman = new Discord.RichEmbed()
	.addField("creepers out prowlin alright", "look at me look at you")
	.addField("take my revenge thats what im gonna do", "im a warrior baby what else is new")
	.addField("and my blades gonna tear through you bring it", "cause baby tonight")
	.addField("the creepers tryna steal all our stuff again", "yeah baby tonight")
	.addField("grab your sword armour and go", "take your revenge oh-oh oh-oh")
	.addField("so fight fight like its the last last night", "of your life life show them your bite")
	.addField("cause baby tonight", "the creepers tryna steal all our stuff again")
	.addField("cause baby tonight", "your grab your pick shovel and bolt again")
	.addField("and run run until its done done", "until the sun comes up in the morn")
	.addField("cause baby tonight", "the creepers tryna steal all our stuff again")
var h = 0
